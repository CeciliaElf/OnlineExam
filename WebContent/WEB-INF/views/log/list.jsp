...
<div class="easyui-layout" data-options="fit:true">
	...
	<div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>日志内容：</label><input class="wu-text easyui-textbox" id="search-name" style="width:150px">
	...
	<form id="add-form" method="post">
        <table>
        	<tr>
                ...
                <td><textarea name="content" id="add-content" rows="6" class="wu-textarea" style="width:260px"></textarea></td>
            </tr>
        </table>
    </form>
</div>
